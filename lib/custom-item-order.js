 ...
 * have been retreived from the system. This is because
 * some articles may not have been retreived due to having
 * been deleted from the system, or due to visibility rules.
 */
function getCustomItemOrder(results, articles) {
